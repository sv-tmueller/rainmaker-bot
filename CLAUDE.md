...
src/rainmaker/
  ...
  kalshi/
    client.py         Kalshi discovery (read-only): daily high-temp markets, secondary venue
    markets.py        Kalshi event ladder -> Market (reuses Bucket/Target; station-name guard)
  store/
